                            ...
                            <dl>
                                ...
                                <FormItem>
                                    ...
                                    <ul class="account-list">
                                        ...
                                        <li>
                                            <a href="https://gitee.com/oauth/authorize?client_id=5569a5c12b03af1083d01f4daa0fd98697b63923151f60813c77a7ff3fad44d5&redirect_uri=http://localhost:8088/qq&response_type=code&state=gitee" style="{right: 26px;}">
                                                <img class="icon" src="../images/gitee.svg" />
                                            </a>
                                        </li>
                                    </ul>
                                </FormItem>
